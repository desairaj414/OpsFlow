...
related_ci_context: teams-notification-queue
---

# PM-005: Incident postmortem — teams-notification-queue

## Summary
An incident affecting a teams-notification-queue was detected, diagnosed, and resolved. This document records
...
## Root cause
A specific, cited contributing factor for this teams-notification-queue instance (not a generic "restart fixed
