...
related_ci_context: message-queue
---

# PM-005: Incident postmortem — message-queue

## Summary
An incident affecting a message-queue was detected, diagnosed, and resolved. This document records
...
## Root cause
A specific, cited contributing factor for this message-queue instance (not a generic "restart fixed
