...
related_ci_context: power-platform-environment
---

# PM-002: Incident postmortem — power-platform-environment

## Summary
An incident affecting a power-platform-environment was detected, diagnosed, and resolved. This document records
...
## Root cause
A specific, cited contributing factor for this power-platform-environment instance (not a generic "restart fixed
