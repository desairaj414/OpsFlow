...
related_ci_context: app-server
---

# PM-002: Incident postmortem — app-server

## Summary
An incident affecting a app-server was detected, diagnosed, and resolved. This document records
...
## Root cause
A specific, cited contributing factor for this app-server instance (not a generic "restart fixed
