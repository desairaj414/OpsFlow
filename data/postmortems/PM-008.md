...
related_ci_context: load-balancer
---

# PM-008: Incident postmortem — load-balancer

## Summary
An incident affecting a load-balancer was detected, diagnosed, and resolved. This document records
...
## Root cause
A specific, cited contributing factor for this load-balancer instance (not a generic "restart fixed
