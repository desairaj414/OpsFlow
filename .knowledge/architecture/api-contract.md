...
[Errors Solved](../reference/errors-solved.md)) degrades visibly instead of silently under-scrubbing free-text
...
**IMPLEMENTED 2026-08-07** — Supervisor→Diagnosis, see [domain-agents.md](../domain/domain-agents.md) for
